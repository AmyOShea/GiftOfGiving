...
USER_TYPE_CHOICES = (("charity", "CHARITY"), ("donor", "DONOR"))
...
class Profile(models.Model):
    ...
    organisation_name = models.CharField(max_length=150, null=False, blank=False, unique=True)
...
class CharityAddress(models.Model):
    ...
    address_line_three = models.CharField(max_length=150, null=True, blank=True)
    county = models.CharField(max_length=150, null=False, blank=False)
